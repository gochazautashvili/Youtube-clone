...
function Aside({
  ...
  return (
    <aside className={`aside ${menu ? "" : "menu"}`}>
      <div className={`aside__content ${menu ? "" : "menu"}`}>
        <button
          onClick={() => setMenu((prev) => !prev)}
          type="button"
          title="burgerMenu"
          className="header__left_burgerMenu"
        >
          <svg
        ...
        <NavLink to="/" className={`aside__content_box ${menu ? "" : "menu"}`}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <NavLink
          to="/shorts"
          className={`aside__content_box ${menu ? "" : "menu"}`}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            height="24"
      ...
      {menu && (
        <>
          <div className="aside__content">
            <NavLink to="/you" className="aside__content_box you">
              <p>You</p>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="16"
            ...
            <NavLink to="/your-channel" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
                width="24"
            ...
            <NavLink to="/history" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
                width="24"
            ...
            <NavLink to="/your-videos" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                enableBackground="new 0 0 24 24"
                height="24"
            ...
            <NavLink to="/watch-later" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
                viewBox="0 0 24 24"
            ...
            <NavLink to="/your-clips" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                enableBackground="new 0 0 24 24"
                height="24"
            ...
            <NavLink to="/liked-videos" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                enableBackground="new 0 0 24 24"
                height="24"
          ...
          <div className="aside__content">
            <p className="aside__content_box you">Subscriptions</p>
            <NavLink to="/kacebi" className="aside__content_box">
              <img
                id="img"
                draggable="false"
                height="24"
                width="24"
                alt=""
                src="https://yt3.ggpht.com/ytc/AIf8zZT7Pcr960gIpD6G96IBq5mOsh1HQQJ8LvoLUBUTCQ=s88-c-k-c0x00ffffff-no-rj"
              />
              <p>კაცები</p>
            </NavLink>
            <NavLink to="/GreatStack" className="aside__content_box">
              <img
                id="img"
                draggable="false"
                height="24"
                width="24"
                alt=""
                src="https://yt3.ggpht.com/dZrWJVS5N3R5R-qkneimoPXYLBC-apFge8e8q94jrMur7bLPc7PaOO1fiwPJrVfsando6fP2=s88-c-k-c0x00ffffff-no-rj"
              />
              <p>GreatStack</p>
            </NavLink>
            <NavLink to="/JavaScript" className="aside__content_box">
              <img
                id="img"
                draggable="false"
                height="24"
            ...
            <NavLink to="/PedroTech" className="aside__content_box">
              <img
                id="img"
                draggable="false"
                height="24"
            ...
            <NavLink to="/Jortsoft" className="aside__content_box">
              <img
                id="img"
                draggable="false"
                height="24"
                width="24"
                alt=""
                src="https://yt3.ggpht.com/Y_URwpsa52D6A_byg1tzk-aYej7rVUnN6w9XvjA2nBpUUlMMyAPA1FOiD4tbrUo-ueSbGjwILa8=s88-c-k-c0x00ffffff-no-rj"
              />
              <p>Jortsoft</p>
            </NavLink>
            <NavLink to="/კოდების" className="aside__content_box">
              <img
                id="img"
                draggable="false"
                height="24"
                width="24"
                alt=""
                src="https://yt3.ggpht.com/ytc/AIf8zZS-liwBOY9mG_sNMuzZgjYfhUIlyOV7QXxEKPtv=s88-c-k-c0x00ffffff-no-rj"
              />
              <p>კოდების სამყარო</p>
            </NavLink>
          </div>
          <div className="aside__content">
            <p className="aside__content_box you">Explore</p>
            <NavLink to="/trending" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                enableBackground="new 0 0 24 24"
                height="24"
            ...
            <NavLink to="/music" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                enableBackground="new 0 0 24 24"
                height="24"
            ...
            <NavLink to="/gaming" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                enableBackground="new 0 0 24 24"
                height="24"
            ...
            <NavLink to="/sports" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                height="24"
                viewBox="0 0 24 24"
          ...
          <div className="aside__content">
            <p className="aside__content_box you">More from YouTube</p>
            <NavLink to="/youtube-premium" className="aside__content_box">
              <svg
                width="24px"
                height="24px"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <NavLink to="/youtube-studio" className="aside__content_box">
              <svg
                width="24px"
                height="24px"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <NavLink to="/youtube-music" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                focusable="false"
            ...
            <NavLink to="/youtube-kids" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                focusable="false"
          ...
          <div className="aside__content">
            <p className="aside__content_box you">Explore</p>
            <NavLink to="/settings" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                enableBackground="new 0 0 24 24"
                height="24"
            ...
            <NavLink to="/Report-history" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                enableBackground="new 0 0 24 24"
                height="24"
            ...
            <NavLink to="/help" className="aside__content_box">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                enableBackground="new 0 0 24 24"
                height="24"
          ...
          <div className="aside__content footer">
            <Link to="nfigbj">
              About Press Copy right Contact usCreators Advertise Developers
            </Link>
            <Link to="dbi">
